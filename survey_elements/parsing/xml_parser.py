...
def question_base(el: ET.Element) -> dict:
    ...
    return {
        ...
        # cardsort
        "cardsort_displayNavigation": _attr(el, "cardsort:displayNavigation"),
        "cardsort_displayCounter": _attr(el, "cardsort:displayCounter"),
        "cardsort_displayProgress": _attr(el, "cardsort:displayProgress"),
        "cardsort_animationDuration": _attr(el, "cardsort:animationDuration"),
        "cardsort_wrapBuckets": _attr(el, "cardsort:wrapBuckets"),
        "cardsort_bucketsPerRow": _attr(el, "cardsort:bucketsPerRow"),
        "cardsort_themeFile": _attr(el, "cardsort:themeFile"),
        "cardsort_automaticAdvance": _attr(el, "cardsort:automaticAdvance"),
        "cardsort_iconButtonCSS": _attr(el, "cardsort:iconButtonCSS"),
        "cardsort_iconButtonDisableCSS": _attr(el, "cardsort:iconButtonDisableCSS"),
        "cardsort_iconButtonHoverCSS": _attr(el, "cardsort:iconButtonHoverCSS"),
        "cardsort_buttonPreviousHTML": _attr(el, "cardsort:buttonPreviousHTML"),
        "cardsort_buttonNextHTML": _attr(el, "cardsort:buttonNextHTML"),
        "cardsort_cardCSS": _attr(el, "cardsort:cardCSS"),
        "cardsort_cardDisableCSS": _attr(el, "cardsort:cardDisableCSS"),
        "cardsort_cardHoverCSS": _attr(el, "cardsort:cardHoverCSS"),
        "cardsort_cardSelectCSS": _attr(el, "cardsort:cardSelectCSS "), 
        "cardsort_dragAndDrop": _attr(el, "cardsort:dragAndDrop"),
        "cardsort_bucketCSS": _attr(el, "cardsort:bucketCSS"),
        "cardsort_bucketDisableCSS": _attr(el, "cardsort:bucketDisableCSS"),
        "cardsort_bucketHoverCSS": _attr(el, "cardsort:bucketHoverCSS"),
        "cardsort_bucketSelectCSS": _attr(el, "cardsort:bucketSelectCSS"),
        "cardsort_bucketCountCSS": _attr(el, "cardsort:bucketCountCSS"),
        "cardsort_bucketCountDisableCSS": _attr(el, "cardsort:bucketCountDisableCSS"),
        "cardsort_bucketCountHoverCSS": _attr(el, "cardsort:bucketCountHoverCSS"),
        "cardsort_progressCSS": _attr(el, "cardsort:progressCSS"),
        "cardsort_contentsCardCSS": _attr(el, "cardsort:contentsCardCSS"),
        "cardsort_completionHTML": _attr(el, "cardsort:completionHTML"),
        "cardsort_completionCSS": _attr(el, "cardsort:completionCSS"),
